            ...
            <div className="grid md:grid-cols-4 gap-5">
              <div className="rounded-[32px] border border-white/10 bg-white/5 p-8">
                ...
                <p className="text-zinc-400 leading-relaxed">
                  Entendé mejor qué está pasando antes de reaccionar.
                </p>
              </div>
              ...
              <div className="rounded-[32px] border border-white/10 bg-white/5 p-8">
                ...
                <p className="text-zinc-400 leading-relaxed">
                  Dividí problemas complejos en partes manejables.
                </p>
              </div>
              ...
              <div className="rounded-[32px] border border-white/10 bg-white/5 p-8">
                ...
                <p className="text-zinc-400 leading-relaxed">
                  Generá alternativas y encontrá caminos posibles.
                </p>
              </div>
              ...
              <div className="rounded-[32px] border border-white/10 bg-white/5 p-8">
                ...
                <p className="text-zinc-400 leading-relaxed">
                  Convertí claridad mental en movimiento real.
                </p>
              </div>
            </div>
          </section>
